...
//   [uint32 count][float32 pos x,y,z * count]
// Same pozycje na skorupie — runtime (hero-scene) renderuje je jako
// nieprzezroczyste punkty z testem głębi (przód kryje tył), więc normalne nie są
// potrzebne; ich pominięcie zmniejsza plik o połowę. Mesh NIE trafia do bundla.
//
